...
export function WalletBox() {
  return (
    <Link
      href="/"
      className="fly fly-wallet fixed top-4 left-4 z-40 border-2 border-black bg-white px-3 py-1.5 text-black shadow-[4px_4px_0_rgba(0,0,0,0.25)] transition-transform hover:-translate-y-0.5 lg:top-6 lg:left-6 lg:border-[3px] lg:px-5 lg:py-2 lg:shadow-[6px_6px_0_rgba(0,0,0,0.25)]"
    >
...
export function SocialChips() {
  return (
    <div className="fly fly-social fixed top-6 right-6 z-40 hidden flex-col gap-6 lg:flex">
  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        className="fly fly-burger fixed top-4 right-4 z-50 flex h-12 w-12 -skew-x-6 flex-col items-center justify-center gap-1.5 border-2 border-black bg-white shadow-[4px_4px_0_rgba(0,0,0,0.35)]"
      >
