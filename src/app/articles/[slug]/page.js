        ...
        <div className="lg:ml-auto lg:w-[56%] lg:pr-[4%]">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap items-center gap-3">
              <span className="font-display inline-block -skew-x-12 bg-[var(--accent)] px-4 py-1 text-lg text-white shadow-[4px_4px_0_rgba(var(--ink-accent),0.3)]">
            ...
            <h1 className="font-display mt-4 skew-x-[-10deg] text-4xl leading-[0.95] text-white [text-shadow:4px_4px_0_rgba(var(--ink),0.55)] md:text-6xl">
              {metadata.title}
            </h1>
